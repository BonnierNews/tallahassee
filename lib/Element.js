...
function Element(document, $elm) {
  ...
  const rects = {};
  rects.top = rects.left = 99999;

  rects.bottom = rects.top + 760 * 2;
  rects.right = rects.left + 760 * 2;
  ...
  function setBoundingClientRect(axes) {
    ...
    rects.height = (rects.bottom || 0) - (rects.top || 0);
    rects.width = (rects.right || 0) - (rects.left || 0);
