...
module.exports = class BrowserTab {
  ...
  async focusIframe(element, src) {
    ...
    if (iframeScope.window.location.hostname === this.window.location.hostname) {
      Object.defineProperty(iframeScope.window, "frameElement", { value: element });
      Object.defineProperty(iframeScope.window, "top", { value: this.window });
    } else {
      Object.defineProperty(iframeScope.window, "top", { value: getLockedWindow(iframeScope.window.location.href) });
    }
