...
class Node extends EventTarget {
  ...
  get parentElement() {
    return this.ownerDocument._getElement(this[kElm].parent());
  }
  get parentNode() {
    return this.parentElement;
  }
  get previousSibling() {
    return this.ownerDocument._getElement(this[kElm].prev());
  }
  get textContent() {
  ...
  contains(el) {
    return this[kElm] === el[kElm] || this[kElm].find(el[kElm]).length > 0;
  }
  getRootNode() {
    return this;
  }
